...
$$
\begin{aligned}
    E[\hat{\beta}_{2SLS}]=&E\left[\left(X'P_ZX\right)^{-1}X'P_Z'(X\beta+u)|X,Z\right]\\
    =&E\left[\left(X'P_ZX\right)^{-1}X'P_Z'X\beta+\left(X'P_ZX\right)^{-1}X'P_Z'u|X,Z\right]\\
    =&E\left[\beta+\left(X'P_ZX\right)^{-1}X'Z(Z'Z)^{-1}\underbrace{Z'u}_{=0}|X,Z\right]=\beta
\end{aligned}
$$