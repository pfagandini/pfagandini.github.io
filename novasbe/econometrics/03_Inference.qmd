...
2. $H_0: \theta_3=0$ can be written as $\beta_2+\beta_3=0$ or $\beta_2=-\beta_3$, that is under the null hypothesis the effects cancell out, or are symmetric.
...
Test if the effect of annual firm sales (in dollars) on scrap rates is the symmetric of the effect of the number of firm employees on scrap rates.

::: {.notes}
$H_0:\theta_3=0$ and $H_a: \theta_3\neq 0$. For $\alpha=5%$ and $dof=43-3-1=39$ the critical value $t^c=2.023$. In this case $t=\frac{0.041}{0.205}=0.2$. Because $t<t^c$ we fail to rjeect $H_0$ at 5%.
...
3. The director of the Natural Parks association is worried about the number of vists to the parks: *"... if not for the nature, at least in financial terms we have to reduce the number of visits, because in order to compensate for an increase of one thousand visitors we have to spend 0.5 millin euros more in maintenance"*. Comment on this sentence.

::: {.notes}
1. If visitors increase by 1000 the N of endangered species icnreases by 3.73 on average ceteris paribus. If maintenance increases by 1 million euros, the number of endangered species decreases by 9.614, on average, ceteris paribus.
...
[Back to the exercise](#ex-3.1-questions)