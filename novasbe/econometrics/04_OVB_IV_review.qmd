...
$$
E[\tilde{\beta}]=(X'X)^{-1}X'Y=(X'X)^{-1}X'(X\beta+\underbrace{W\gamma+\epsilon}_{u})=\beta+(X'X)^{-1}X'Z\gamma
$$

Note that $(X'X)^{-1}X'Z$ is the estimator for $\alpha$ of $Z=X\alpha+\epsilon$, and then
