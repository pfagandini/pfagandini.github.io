...
\begin{frame}
    \begin{definition}
        A \textbf{vector} is an element $V$ of $\mathbb{R}^n$, for $n\geq 2$. A scalar is an element of $\mathbb{R}$.
    \end{definition}
    ...
    \begin{align*}
        V=\left(\begin{array}{c}
             ...
             v_{n-1}\\
             v_n
        \end{array}\right) \quad \in \quad \mathbb{R}^n
    \end{align*}
\end{frame}
...
\begin{frame}
    \begin{definition}
        A \textbf{vector space} $\mathcal{S}$, satisfies that, for any $A,B \in \mathcal{S}$, and $\alpha\in \mathbb{R}$,
    ...
    It is trivial to show that $\mathbb{R}^n$ is a vector space.
    
    \begin{definition}
        A nonempty set $\mathcal{S}\subseteq \mathbb{R}^n$ is a \textbf{vector subspace} of $\mathbb{R}^n$ if, with the vector addition and the scalar multiplication it is a vector space by itself.
    \end{definition}
\end{frame}

\begin{frame}
    \begin{proposition}
       Let $\mathcal{V}\subseteq\mathbb{R}^n$, nonempty. $\mathcal{V}$ is a vector subspace of $\mathbb{R}^n$ if and only if,
        
        \begin{enumerate}
            \item $0\in \mathcal{V}$,
            \item $a,b\in \mathcal{V}$, $\alpha\in \mathbb{R}$, then $a+\alpha b\in \mathcal{V}$
        \end{enumerate}
    \end{proposition}
...
\begin{frame}
    \begin{proof}
        \begin{itemize}
            \item $\Rightarrow$... If $\mathcal{V}$ is v.s. of $\mathbb{R}^n$, we know that the scalar multiplication and the sum is in the space. Because scalar mult. we know that $\alpha b\in\mathcal{V}$, so the sum must be in $\mathcal{V}$ too. \pause
...
\begin{frame}
    ...
    Let $\mathcal{V}\subseteq\mathbb{R}^n$ be a set of $k$ vectors, then, $Z\in\mathbb{R}^n$ is a \textbf{linear combination} of the vectors $\{V_i\}_{i=1}^k$in $\mathcal{V}$ if there are scalars $\alpha_j$ $j=1,...,k$ such that,
...
\begin{frame}
    \begin{proposition}
        \begin{enumerate}
            \item Let $\mathcal{V},\mathcal{W}\subseteq\mathbb{R}^n$, such that $\mathcal{V}\subseteq \mathcal{W}$, then $L(\mathcal{V})\subseteq L(\mathcal{W})$
            \item If $Y\in L(\mathcal{V})$, then $L(\{Y\}\cup \mathcal{V}) = L(\mathcal{V})$
            \item Given a nonempty $\mathcal{V}\subseteq\mathbb{R}^n$, then $L(\mathcal{V})$ is a vector subspace of $\mathbb{R}^n$.
        \end{enumerate}\pause
    \end{proposition}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \item $0$ belongs to any $L()$, as it is the case with scalars $=0$. Now, let $X,Y\in L(\mathcal{V})$ and $\gamma\in\mathbb{R}$; $X+\gamma Y = \sum_{v_i\in\mathcal{V}}(\alpha_i+\gamma \beta_i) v_i$ if we write each vector as a linear comb. For the same argument used before, we complete the proof.
    \end{enumerate}
    \end{proof}
...
\begin{frame}
    ...
    \begin{definition}
    A set of $k$ vectors $\mathcal{V}\subseteq \mathbb{R}^n$ is \textbf{linearly independent} if, $\forall \alpha_j \in \mathbb{R}$
...
\begin{frame}
    ...
    The set of vectors $\mathcal{X}\subseteq\mathcal{V}$ \textbf{generates} the vector subspace $\mathcal{V}\subseteq\mathbb{R}^n$ if any $V\in\mathcal{V}$ can be written as a linear combination of the vectors in $\mathcal{X}$.
...
\begin{frame}
\begin{proposition}
    Let $\mathcal{X}=\{X_1,X_2,\ldots,X_k\}$ a basis of the vector subspace $\mathcal{V}\subseteq\mathbb{R}^n$. Then, for any $V\in\mathcal{V}$, there are \textbf{unique} scalars $\{\alpha_i\}_{i=1}^k$ such that
...
\begin{proposition}
    Any set of $n$ linearly independent vectors $\mathcal{X}\subseteq\mathbb{R}^n$, generates $\mathbb{R}^n$
\end{proposition}
...
\begin{frame}
    \begin{definition}
        Given $X,Y\in\mathbb{R}^n$, the \textbf{inner product} corresponds to:
        
        \begin{align*}
            X\cdot Y = \sum_{j=1}^n x_j y_j \quad\in \mathbb{R}
        \end{align*}
    \end{definition}
    
    \begin{definition}
        The \textbf{Euclidean norm} of a vector $X\in\mathbb{R}^n$ is:
        
        \begin{align*}
            ||X||=\sqrt{X\cdot X} = \sqrt{\sum_{j=1}^n x_j^2} \quad \in\mathbb{R}
        \end{align*}
    \end{definition}
\end{frame}
...
\begin{frame}
    \begin{definition}
        For $X,Y\in\mathbb{R}^n$, the \textbf{Euclidean distance} between them is defined as:
...
\begin{frame}
    \begin{definition}
        For $X,Y\in\mathbb{R}^n$, both different from zero, the \textbf{angle} between them, denoted as $\angle(X,Y)$, is defined as the value that satisfies,
...
\begin{frame}
    ...
    Let $X\in\mathbb{R}^n$. If $||X||=1$, $X$ is a \textbf{unit vector}.
    
    \end{definition}
    
    \begin{definition}
    
    Consider two vectors $X,Y\in\mathbb{R}^n$, both different from zero. The \textbf{projection} of $Y$ over $X$ is defined as:
