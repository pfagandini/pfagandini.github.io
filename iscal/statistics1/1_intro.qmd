...
|---------------|---------------|---------------|---------------|---------------|
| Midterm 1           | 60%        | 80 minutes | Topics 1 and 2 | Nov 6<sup>th</sup>    |
| Midterm 2       | 40%        | 80 minutes | Topic 3        | Dec 11<sup>th</sup> |
...
$$\left(`r round(1650/1500,4)`\right)^{1/`r hicp_df_a[4,1]- hicp_df_a[1,1]`}=1+\delta_w$$

. . .

$$`r round((1650/1500)^(1/(hicp_df_a[4,1]-hicp_df_a[1,1])),4)`-1=\delta_w \quad \Rightarrow \quad \delta_w=`r round((1650/1500)^(1/(hicp_df_a[4,1]-hicp_df_a[1,1]))-1,4)`= `r round(100*(1650/1500)^(1/(hicp_df_a[4,1]-hicp_df_a[1,1]))-100,2)`\%$$
