...
2. The average growth rate for the wages between `r hicp_df_a[1,1]` and `r hicp_df_a[4,1]`  was _______?
...
<table data-fragment-index = "0" class="fragment">
  <tr>
    <th data-fragment-index="0" class="fragment"> Year </th>
    <th data-fragment-index="0" class="fragment">`r hicp_df_a[1,1]` </th>
    <th data-fragment-index="0" class="fragment">`r hicp_df_a[2,1]`</th>
    <th data-fragment-index="0" class="fragment">`r hicp_df_a[3,1]`</th>
    <th data-fragment-index="0" class="fragment">`r hicp_df_a[4,1]`</th>
  </tr>
  <tr>
    <td data-fragment-index="0" class="fragment">CPI</td>
    <td data-fragment-index="0" class="fragment">`r hicp_df_a[1,2]`</td>
    <td data-fragment-index="0" class="fragment">`r hicp_df_a[2,2]`</td>
    <td data-fragment-index="0" class="fragment">`r hicp_df_a[3,2]`</td>
    <td data-fragment-index="0" class="fragment">`r hicp_df_a[4,2]`</td>
  </tr>
  <tr>
    <td data-fragment-index="0" class="fragment">CPI<sub>link</sub></td>
    <td data-fragment-index="1" class="fragment"> --- </td>
    <td data-fragment-index="2" class="fragment">`r round(hicp_df_a[2,2]/hicp_df_a[1,2]*100,1)`</td>
    <td data-fragment-index="3" class="fragment">`r round(hicp_df_a[3,2]/hicp_df_a[2,2]*100,1)`</td>
    <td data-fragment-index="4" class="fragment">`r round(hicp_df_a[4,2]/hicp_df_a[3,2]*100,1)`</td>
  </tr>
</table>
...
$$FPI_{t|0}\times FQI_{t|0}=$$
$$\sqrt{LPI_{t|0}\times PPI_{t|0}}\times\sqrt{LQI_{t|0}\times PQI_{t|0}}$$
$$\sqrt{LPI_{t|0}\times PPI_{t|0}\times LQI_{t|0}\times PQI_{t|0}}$$
$$\sqrt{LPI_{t|0}\times PQI_{t|0}\times LQI_{t|0}\times PPI_{t|0}}$$
$$\sqrt{IV_{t|0}\times IV_{t|0}}=\sqrt{IV_{t|0}^2}$$
$$IV_{t|0}$$
...
$$IPL_{2|1}=\frac{\sum_{k=1}^m p_2^k q_1^k}{\sum_{k=1}^m p_0^k q_0^k}$$

. . .

$$IPL_{2|1}=\frac{1,763,521\times 1.25 + 3,148,350 \times 1.35}{1,763,521\times 1.15 + 3,148,350 \times 1.2}=`r round((1763521 * 1.25 + 3148350 * 1.35)/(1763521*1.15 + 3148350*1.2),4)`$$