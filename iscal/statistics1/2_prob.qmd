...
1. Woman: $P(W)=\frac{525}{1000}=`r round(515/1000,3)`$
...
$P(U|W)=P(U\cap W)P(W)=`r round(55/1000,3)`\times `r round(515/1000,3)`=`r round(55/525,3)`$
...
Consider a financial institution that sells two products, $A$ and $B$, with very high yields. It is known that, among its clients, 10% invest a share of their wealth in $A$ and the rest in $B$. From those who invest in $A$, 70% manage to get returns above the market. From among those who do not invest in $A$, 55% get returns above the market. Randomly choosing a client of this firm, find the probability this customer gets a return above the market.

## Example

Let's define the events:

* $A_1$ the clients that invest in $A$
* $A_2$ the clients that invest in $B$
* $B$ return above the market.
