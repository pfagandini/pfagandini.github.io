...
In our previous example, the base day would have been `{python} f'{start_date.day}/{start_date.month}/{start_date.year}'`. Note that in the base year $$I_0=\frac{x_0}{x_0}\times 100 = 100$$