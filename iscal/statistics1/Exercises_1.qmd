...
1. Build the index series with fix base in 2013.
...
2. `r mcq(c("True", "False", answer = "True"))` We could say that in year 2015, according to the index computed above, sales increased 20%.
